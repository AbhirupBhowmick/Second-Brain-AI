...
const LoginForm: React.FC<LoginFormProps> = ({ onSubmit, onGuestLogin, onSwitchToSignup, loading, error }) => {
  ...
  const isSuccess = error.toLowerCase().includes('created') || error.toLowerCase().includes('success');
    ...
    <div className="w-full space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-400">
      ...
      <div className="space-y-1.5 text-left">
        ...
        <p className="text-sm text-zinc-400 font-normal leading-relaxed">
          Access your personal knowledge network.
        </p>
      </div>
