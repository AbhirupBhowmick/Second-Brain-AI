...
const LoginForm: React.FC<LoginFormProps> = ({ onSubmit, onGoogleLogin, onSwitchToSignup, loading, error }) => {
  ...
  return (
    <div className="w-full space-y-7 animate-in fade-in slide-in-from-bottom-4 duration-400">
      {/* Header */}
      <div className="space-y-1.5">
        ...
        <p className="text-sm text-zinc-400 font-normal leading-relaxed">
          Continue building your knowledge network.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4" noValidate>
        ...
        <button
          ...
          className="w-full py-3.5 px-5 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold text-sm transition-all duration-200 shadow-lg shadow-indigo-600/20 hover:shadow-indigo-500/30 hover:-translate-y-0.5 flex items-center justify-center gap-2.5 group cursor-pointer"
        >
          {loading ? (
            <>
      ...
      <button
        ...
        className="w-full py-3.5 px-5 rounded-xl bg-zinc-900/90 hover:bg-zinc-800/90 border border-white/[0.08] hover:border-white/[0.14] text-zinc-200 font-medium text-sm transition-all duration-200 flex items-center justify-center gap-3 cursor-pointer group disabled:opacity-60 disabled:cursor-not-allowed"
      >
